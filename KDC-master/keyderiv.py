...
def MakeMIC(pwd, ssid, A, B, data, wpa = False):
    ...
    #Password based key derivation funciton 2 (hash_name, passwd, salt, iterations,dklen=None)
...
def RunTest():
    ...
    #The first MIC
    mic1 = "D48AD11C97F076B84138E9CED6969CB2"
    ...
    #The third MIC
    mic3 = "D5F07A0FBC8F376541D46591FDA74470"
